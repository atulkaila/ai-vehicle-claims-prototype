...
$css = @'
body { font-family: 'Segoe UI', Arial, sans-serif; max-width: 900px; margin: 12px auto; padding: 0 20px; color: #24292f; line-height: 1.45; font-size: 10.5pt; }
h1 { font-size: 1.7em; border-bottom: 2px solid #d0d7de; padding-bottom: 0.25em; margin-top: 0.2em; }
h2 { font-size: 1.3em; border-bottom: 1px solid #d0d7de; padding-bottom: 0.25em; margin-top: 1.2em; }
h3 { font-size: 1.05em; margin-top: 1em; margin-bottom: 0.4em; }
table { border-collapse: collapse; width: 100%; margin: 0.7em 0; font-size: 0.92em; page-break-inside: avoid; }
th, td { border: 1px solid #d0d7de; padding: 5px 8px; text-align: left; vertical-align: top; }
th { background: #f6f8fa; font-weight: 600; }
code { background: #f6f8fa; padding: 2px 5px; border-radius: 3px; font-family: Consolas, 'Cascadia Code', monospace; font-size: 0.9em; }
pre { background: #f6f8fa; padding: 10px; border-radius: 5px; overflow-x: auto; font-family: Consolas, monospace; font-size: 0.82em; line-height: 1.35; page-break-inside: avoid; }
